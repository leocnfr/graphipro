...
@section('content')
    <link rel="stylesheet" href="/css/photocopy.css">
    <div id="container" class="x_size">
        <div id=contents>

            <div class=content_head>
                <div style="background:#29ABE2;">
                    <center><h1 style="color:white;margin:0px;">PHOTOCOPIE</h1></center>
                </div>
                ...
                <table class=table1>
                    <form id="cartform" name=forms action="cart.php?protype=photocopy" method="post">
                        <tr>
                            <td><b>Format</b> :
                            <td>
                                <input type=radio name=format class=format value=a4r id=a4r onclick=copie_serie()
                                       checked=checked> A4 Recto
                                <input type=radio name=format class=format value=a4rv id=a4rv onclick=copie_serie()> A4
                                Recto-Verso
                                <input type=radio name=format class=format value=a3r id=a3r onclick=copie_serie()> A3
                                Recto
                                <input type=radio name=format class=format value=a3rv id=a3rv onclick=copie_serie()> A3
                                Recto-Verso
                            </td>
                        <tr>
                            <td><b>Couleur</b> :
                            <td>
                                <input type=radio name=couleur class=couleur value=nb onclick=copie_serie()
                                       checked=checked> Noir
                        ...
                        <tr>
                            ...
                            <td colspan=2>
                                <input name=pgs id=pgs onkeypress="return uniquenum()" onkeyup=copie_serie()
                                       maxlength=5> page(s) x
                                <input name=qty id=qty onkeypress="return uniquenum()" onkeyup=copie_serie() maxlength=5
                                       value=1> block(s) ou cahier(s)
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan=2>
                                ...
                                <input type=radio name=reli class=relis onclick=copie_serie() value=pique> Piqûre à
                                cheval (offert)
                                <input type=radio name=reli class=relis onclick=copie_serie() value=spiraleplastique>
                        ...
                        <tr class="bolder">
                            <td>Tarif total :
                            <td><input type=text name=ht id=ht readonly> € TTC
                        <tr class="bolder">
                            <td>
                            <td><input type=text name=ttc id=ttc readonly> € HT
                        </tr>

                </table>
                <center>
                    <div id="btn-submit"
                         style="padding:8px; background-color:#29ABE2; width:100px; border-radius:3px; font-size:18px; margin-top:15px; color:#FFF;cursor: pointer;">
