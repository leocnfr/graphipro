<div style="height:20px; font-size:12px; color:#999; background-color:#E6E6E6; width:100%">
    <div style="width:1000px; margin:0 auto;">Imprimeur Paris, impression pas cher, flyers, bâches - Votre imprimeur
        discount parisien
    </div>
</div>
    ...
    <div style="width:1000px; margin:0 auto;">
        ...
        <div style="float:right;">
            <center>
                ...
                <div style="font-size:16px; color:#999; line-height:18px; ">Du lundi au vendredi<br>
                    de 9h30 à 18h30
                </div>
            </center>
        </div>
...
<div id="jump" style="width:100%;  height:55px; background-image:url(/images/bar.png)">
    <div style="width:1000px; margin:0 auto;">
        <!--menu1 -->
        <div class="menu1" style="float:left; font-size:17px; line-height:18px; height:55px; position:relative">
            ...
            <div class="headmenu" onmouseover="$(this).show()" onmouseout="$(this).hide()">
                ...
                <div class="noregle" style="float:left; margin-left:20px;">
                    <!--                    <img src="images/fleche2.png"/> <span-->
                    <!--                        style="font-size:20px; color:#29ABE2">Documents reliés</span><br/>-->

                    <!--                    <div style="margin-left:14px;">-->
                    <!--                        --><?php
                    //                            showProduct("product","`type`='6' and isshow='1'","name");
                    //                        ?>
                            <!--                    </div>-->
        ...
        {{--<div class="menu1"--}}
             {{--style="float:left; font-size:17px;  line-height:18px; border-left:thin ridge #FFF; height:55px; position:relative">--}}
            {{--<a class="aa" href="#" onmouseover="$(this).next().show()" onmouseout="$(this).next().hide()">--}}
        ...
        {{--</a>--}}
        {{--<a href='espace-client.php' style='padding:0px; float:right; border-radius:0 0 8px 8px; background-color:#29ABE2; height:45px; font-size:16px; color:#FFF; margin-right:0px;'><center><img src='images/login.png'>Espace-Client</center></a>--}}
                {{--<!--panier -->--}}
    </div>
