    ...
    <form action="{{url('/login')}}" method="post">
        ...
        <div style="padding:10px; border:thin ridge #29ABE2; border-radius:3px; font-size:14px; color:#666; width:400px; margin:40px auto;">
            <center>
                ...
                @endif
                <input name="email" type="text" size="30" placeholder="Votre adresse mail" style="font-size:16px; padding:5px" required /><br /><br />
                ...
                <a href="{{url('/register')}}" style="text-decoration:underline; color:#29ABE2">Mot de passe oublié?</a> / <a href="{{url('/inscription')}}" style="text-decoration:underline; color:#29ABE2">Inscription</a>
            </center>
        </div>
    </form>
