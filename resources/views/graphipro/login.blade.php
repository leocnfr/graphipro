    ...
    <form action="doLogin.php" method="post">
        ...
        <div style="padding:10px; border:thin ridge #29ABE2; border-radius:3px; font-size:14px; color:#666; width:400px; margin:40px auto;">
            <center>
                ...
                <a href="{{url('/inscription')}}" style="text-decoration:underline; color:#29ABE2">Mot de passe oublié?</a> / <a href="{{url('/inscription')}}" style="text-decoration:underline; color:#29ABE2">Inscription</a>
            </center>
        </div>
    </form>
